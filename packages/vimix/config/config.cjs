...
var getRoot = /* @__PURE__ */ __name(() => {
  if (typeof __require !== "undefined" && typeof __require.resolve !== "undefined") {
    return path.dirname(__require.resolve("vimix/package.json"));
  }
  return path.dirname(module$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('out.js', document.baseURI).href))).resolve("vimix/package.json"));
}, "getRoot");
var pkgRoot = getRoot();
console.log(pkgRoot);
path.join(pkgRoot, "templates");
